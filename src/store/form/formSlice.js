...
const initialState = {
    name: '', phone: '', format: 'delivery', address: '', floor: '', intercom: '', error: null, errors: {}, touch: false
}

export const submitForm = createAsyncThunk('form/submit', async (data, {dispatch, rejectedWithValue}) => {
    try {
...
const formSlice = createSlice({
    name: 'form', initialState, reducers: {
