...
import logoIcon from '../../assets/img/logo-o.svg';
        ...
        <footer className="footer">
            <Container>
                <div className={style.content}>
                    <img className={style.logo} src={logoIcon} alt="Логотип YourMeal"/>

                    <address className={style.address}>
                        <div className={style.contact}>
                            <h2 className={style.title}>Номер для заказа</h2>

                            <a className={style.phone} href="tel:+375123456789">
                    ...
                    <div className={style.development}>
                        <p>© YouMeal, 2023</p>
                        <p>Developer: <a href="mailto:andrey.slesarchuk@gmail.com">Andrey Slesarchuk</a></p>
                    </div>
                </div>
            </Container>
        </footer>
